...
const BookingDateComp = (props) => {
  const [selectedDate, setSelectedDate] = useState(
    "Thu Jan 15 2088 00:00:00 GMT+0500 (Pakistan Standard Time)"
  );
        ...
        <div className="nova-booking-date_comp_date_view">
          ...
          <LocalizationProvider dateAdapter={AdapterDayjs}>
            <DateCalendar
              ...
              onChange={(text) => setSelectedDate(text.$d)}
            />
                ...
                {morningTimeSlots.map((item, index) => {
                  return (
                    <div
                      ...
                      onClick={() => updateSlot(morningTimeSlots, index)}
                    >
                      <h3>{item.time}</h3>
                    </div>
                  );
                ...
                {afternoonTimeSlots.map((item, index) => {
                  return (
                    <div
                      ...
                      onClick={() => updateSlot(afternoonTimeSlots, index)}
                    >
                      <h3>{item.time}</h3>
                    </div>
                  );
                ...
                {eveningTimeSlots.map((item, index) => {
                  return (
                    <div
                      ...
                      onClick={() => updateSlot(eveningTimeSlots, index)}
                    >
                      <h3>{item.time}</h3>
                    </div>
                  );
