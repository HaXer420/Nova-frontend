    ...
    return (
        <div className="nova-booking-my_info_comp_top_view">
            ...
            <div className='nova-booking-my_info_comp_inputs_top_view'>
                ...
                <div onClick={() => setTerms(!terms)} className='nova-booking-my_info_comp_radia_button_view'>
                    <div>
                        {terms &&
                            <img src={tick} />}
                    </div>
                    <h4>By submitting this form, you agree to receive appointment notifications from NOVA threading & Waxing</h4>
                </div>
